...
const Hero = () => {
  ...
  return (
    ...
    <div className='px-8 md:px-20 py-10 '>
        ...
        <h1 className=' text-[34px] sm:text-[46px] md:text-[54px] lg:text-[72px] xs:text-3xl text-white font-bold text-center max-w-5xl flex mx-auto '>DHISHNA CAMPUS AMBASSADOR</h1>
        <p className='text-center text-white font-md lg:text-[24px] md:text-[20px] text-[16px]'>Be the emissary of Dhishna 2023</p>
        <div className='flex md:flex-row flex-col justify-center my-10'>
            <div className='cursor-pointer group md:mr-10 md:px-16 px-5 py-4 bg-white hover:-translate-x-2 hover:-translate-y-2 transform transition-transform duration-200 ease-in-out mb-10' >
            ...
            <div className='cursor-pointer group md:mr-10 md:px-16 px-5 py-4 bg-black bg-opacity-40 hover:-translate-x-2 hover:-translate-y-2 transform transition-transform duration-200 ease-in-out mb-10'>
        ...
        <div className='flex justify-center my-5'>
            <div className='grid grid-cols-1 md:grid-cols-3 gap-x-20 lg:gap-x-60 gap-y-10'>
