  ...
  return (
    ...
    <div className='px-20 py-20 bg-prple-950'>
        ...
        <div className='flex md:flex-row flex-col justify-center my-16'>
            <div className='cursor-pointer group mr-10 md:px-16 px-5 py-4 bg-white hover:-translate-x-2 hover:-translate-y-2 transform transition-transform duration-200 ease-in-out mb-10' >
            ...
            <div className='cursor-pointer group mr-10 md:px-16 px-5 py-4 bg-black bg-opacity-40 hover:-translate-x-2 hover:-translate-y-2 transform transition-transform duration-200 ease-in-out mb-10'>
