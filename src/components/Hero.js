  ...
  return (
    <div className="spacebg">
      <div className="px-20 py-20 bg-prple-950">
        ...
        <h1 className="my-5 md:text-8xl text-3xl text-white font-bold text-white text-center my-5">
          CAMPUS AMBASSADOR
        </h1>
        ...
        <div className="flex md:flex-row flex-col justify-center my-16">
          ...
          <div className="ml-10 cursor-pointer group mr-10 md:px-16 px-5 py-4 bg-black bg-opacity-40 hover:-translate-x-2 hover:-translate-y-2 transform transition-transform duration-200 ease-in-out mb-10">
            ...
            <p className="text-white text-center font-bold text-md text-xl">
              EXPLORE
            </p>
          </div>
        </div>
        <div className="flex justify-center my-20">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-x-60 gap-y-10">
            <div className="md:px-10 px-7 md:py-12 py-9 rounded-[50%] bg-white">
              <h3 className="text-black font-semibold text-5xl text-center">
                {animateCountUp && <CountUp end={30} duration={3} />}+
              </h3>
              <p className="text-black text-md my-2 text-center font-semibold">
                WORKSHOPS
              </p>
            </div>
            <div className="md:px-10 px-7 md:py-10 py-9 rounded-[50%] bg-white">
              <h3 className="text-black font-semibold text-5xl text-center">
                {animateCountUp && <CountUp end={12} duration={4} />}+
              </h3>
              <p className="text-black text-md my-2 text-center font-semibold">
                LECTURES
              </p>
            ...
            <div className="md:px-10 px-7 md:py-10 py-9 rounded-[50%] bg-white">
              <h3 className="text-black font-semibold text-5xl text-center">
                {animateCountUp && <CountUp end={44} duration={5} />}+
              </h3>
              <p className="text-black text-md my-2 text-center font-semibold">
                SPONSORS
              </p>
