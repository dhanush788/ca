...
const Hero = () => {
  ...
  return (
    <div className='px-20 py-20 bg-purple-950'>
        ...
        <div className='flex md:flex-row flex-col justify-center my-16'>
            <div className='mr-10 px-16 py-4 bg-white border-4 border-white hover:-translate-x-2 hover:-translate-y-2 transform transition-transform duration-200 ease-in-out mb-10' >
            ...
            <div className='group mr-10 px-16 py-4 bg-black bg-opacity-40 hover:-translate-x-2 hover:-translate-y-2 transform transition-transform duration-200 ease-in-out mb-10'>
