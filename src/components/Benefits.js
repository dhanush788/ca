...
const Benefits = () => {
    return (
        <div className='w-full flex items-center text-center flex-col py-24 px-6 sm:px-10 bg-black relative  bg-opacity-70 '>
            <div className='w-full flex items-center text-center flex-col py-24 px-6 sm:px-10 rounded rounded-[40px] bg-black '>
                ...
                <div className='mid-glow  absolute mt-[250px]  h-56'>
                    hi
                </div>
            </div>
            <div className='z-[2]'>

            <p className='text-[#F0FF59] text-[18px] max-w-lg font-medium pt-12 tracking-widest '>Special certificate for top 20 people
