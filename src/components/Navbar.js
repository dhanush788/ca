  ...
  return (
    ...
    >
      <div className="w-full flex justify-between items-center max-w-7xl mx-auto">
        ...
        <button class="bg-white hidden sm:flex py-2.5 px-4 text-[12px] font-extrabold rounded uppercase tracking-[0.25rem]">
          Sign in
        </button>
      </div>
    </nav>
                    ...
                    <div className="flex flex-row  justify-center align-center my-auto">
                        <img src={logo} alt="logo" className="w-24 h-24 object-contain " />
                        <div className='flex flex-col my-auto'>
                            <p className="text-white text-lg font-extrabold cursor-pointer tracking-[0.45rem] ">DHISHNA</p>
                            <p className='text-white font-medium text-[10px]'>SOE | CUSAT</p>
                        </div>
                    </div>
                </div>
