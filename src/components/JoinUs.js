...
const JoinUs = () => {
  return (
    <div className='px-10 md:px-20 py-20 bg-black bg-opacity-90'>
        ...
        <h4 className='text-white text-center text-xl md:text-2xl font-bold'>ARE YOU READY?</h4>
        <h4 className='text-white text-center text-xl md:text-2xl font-bold mt-5'>TO BE A PART OF THE BIGGEST TECH FEST IN SOUTH INDIA</h4>
